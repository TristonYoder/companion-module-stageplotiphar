	...
	return [
		{
			type: 'textinput',
			id: 'host',
			label: 'StagePlotiphar URL',
			tooltip: 'Base URL of your StagePlotiphar instance. Change this if you self-host instead of using plotiphar.com.',
			width: 8,
		...
		},
		{
			...
			id: 'apiKey',
			label: 'API Key',
			tooltip: 'Created under Settings → API Keys in StagePlotiphar',
			width: 8,
			default: '',
			required: true,
		},
